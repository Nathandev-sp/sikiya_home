...
export default function PublisherArticleReviewPage() {
  ...
  const checkPublisherAccess = async () => {
    try {
      ...
      if (!token) {
        router.push('/login?redirect=/publisher/articles/pending');
        return;
      }
  ...
  const fetchArticle = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/publisher/articles/${articleId}`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
        },
  ...
  const submitApproval = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/publisher/articles/${articleId}/approval`, {
        method: 'PATCH',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <button
          onClick={() => router.push('/publisher/articles/pending')}
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            {editing ? (
              ...
              <h1 className="text-2xl font-bold text-gray-900">{article.article_title}</h1>
            )}
          </div>
          ...
          <div>
            ...
            {editing ? (
              ...
              <p className="text-base text-gray-700">{article.article_highlight}</p>
            )}
          </div>
          ...
          {article.article_front_image && (
            <div className="flex justify-center w-full">
              <div className="relative bg-gray-200 rounded-lg overflow-hidden border border-gray-300 shadow-sm" style={{ width: '100%', maxWidth: '700px', aspectRatio: '16/9' }}>
                <SafeImage
          ...
          <div>
            ...
            {editing ? (
              ...
              <div className="prose max-w-none">
                <p className="text-base text-gray-700 whitespace-pre-wrap leading-relaxed">{article.article_content}</p>
              </div>
            )}
          </div>
          ...
          {article.article_other_images && article.article_other_images.length > 0 && (
            <div>
              ...
              <div className="flex justify-center w-full">
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4" style={{ width: '100%', maxWidth: '550px' }}>
                  {article.article_other_images.map((imageKey, index) => (
                    <div key={index} className="relative bg-gray-200 rounded-md overflow-hidden border border-gray-300 shadow-sm" style={{ aspectRatio: '4/3', width: '100%' }}>
                      <SafeImage
                        src={imageKey}
          ...
          <div className="bg-gray-50 rounded-lg p-5 border border-gray-200">
            <h3 className="text-base font-semibold text-gray-900 mb-4">Article Information</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white rounded-md p-3 border border-gray-200">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-xs font-medium text-gray-500 uppercase">Article Group</span>
                </div>
                <p className="text-sm font-semibold text-gray-900">{article.article_group}</p>
              </div>
              ...
              <div className="bg-white rounded-md p-3 border border-gray-200">
                ...
                <p className="text-sm font-semibold text-gray-900">{article.location}</p>
              </div>
              ...
              <div className="bg-white rounded-md p-3 border border-gray-200">
                ...
                <p className="text-sm font-semibold text-gray-900">{article.concerned_country}</p>
              </div>
              ...
              <div className="bg-white rounded-md p-3 border border-gray-200">
                ...
                <p className="text-sm font-semibold text-gray-900">{article.concerned_city}</p>
              </div>
          ...
          {(article.article_proof_image || article.article_proof_text) && (
            <div className="bg-gray-50 rounded-lg p-5 border border-gray-200">
              <h3 className="text-base font-semibold text-gray-900 mb-4">Proof Information</h3>
              
              {article.article_proof_text && (
                <div className="mb-4">
                  <label className="block text-sm font-medium text-gray-700 mb-2">Proof Text</label>
                  <p className="text-sm text-gray-700 whitespace-pre-wrap bg-white p-3 rounded-md border border-gray-200">
                    {article.article_proof_text}
                  </p>
                </div>
              )}
              ...
              {article.article_proof_image && (
                <div>
                  ...
                  <div className="flex justify-center w-full">
                    <div className="relative bg-gray-200 rounded-md overflow-hidden border border-gray-300 shadow-sm" style={{ width: '100%', maxWidth: '500px', aspectRatio: '4/3' }}>
                      <SafeImage
          ...
          {article.journalist_id && (
            <div className="bg-gray-50 rounded-lg p-5 border border-gray-200">
              <h3 className="text-base font-semibold text-gray-900 mb-4">Journalist Information</h3>
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  {article.journalist_id.journalist_description && (
                    <p className="text-sm text-gray-600 mt-2 line-clamp-3">{article.journalist_id.journalist_description}</p>
                  )}
                </div>
              </div>
            </div>
          ...
          {!editing && (
            <div className="pt-5 border-t border-gray-200 space-y-4">
              <h3 className="text-base font-medium text-gray-900">Approve or Reject Article</h3>
